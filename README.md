...
* **분석결과**: 아래 순서대로 푸시 알림 반응률이 높았음
   ```
   2ndLife > 중년기타 > 사회초년생 > 자녀 대학생 > 자녀 의무 교육 > 신혼 > 은퇴 > 대학생 > TEEN > 자녀 영유아
   ```
...
핵심 니즈: 중년기타와 마찬가지로 다양한 생활 편의 (시설관리 21.33%, 요식업 13.91)
```
...
> **마케팅 전략 제안 3줄 요약:**
> 1. 975만 건 데이터 분석 결과, **저사용 고객충 중푸시 알림 반응률 상위 5개 그룹** 을 타겟
